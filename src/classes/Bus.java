...
public class Bus {
    ...
    public Ligne lineWeekDirection1;
    public Ligne lineWeekDirection2;
    public Ligne lineSaturdayDirection1;
    public Ligne lineSaturdayDirection2;
    ...
    */
    ...
    public Bus(String pathFile){
        Reading readFile = new Reading(pathFile);
    ...
    public void setCleanData() {
        ...
        */
        ...
        this.lineWeekDirection1 = new Ligne(raw_weekDirection1);
        this.lineWeekDirection2 = new Ligne(raw_weekDirection2);
        this.lineSaturdayDirection1 = new Ligne(raw_saturdayDirection1);
        this.lineSaturdayDirection2 = new Ligne(raw_saturdayDirection2);
    ...
    */
    ...
    public ArrayList<NodeArret> getAllNodeBusStops(String typeDay, String busName){
    ...
    */
    ...
    public boolean hasBusStop(String nameBusStop) {
        ...
        Ligne[] listLine = {lineWeekDirection1, lineWeekDirection2, lineSaturdayDirection1, lineSaturdayDirection2};

        // for each line possibility
        for (Ligne line: listLine){
    ...
    public ArrayList<Ligne> listLineOfTheDay(String typeDay){
        ArrayList<Ligne> output_listLineOfTheDay = new ArrayList<>();
        switch (typeDay) {
            case "no data available":
    ...
    public Ligne lineInThisDirection(String firstBusStopName, String secondBusStopName, String typeDay){
        for (Ligne l: listLineOfTheDay(typeDay)){
    ...
    */
    ...
    public ArrayList<NodeArret> getArrayNearestBusStop(String busStopName, String nameLine, String typeDay){
...
//                }
    ...
    public ArrayList<NodeArret> busStopToNodeBusStop(String busStopName, String typeDay) {
        ...
        ArrayList<NodeArret> nodeBusStopArrayListClean = new ArrayList<>();
        switch (typeDay) {
            case "saturday or summer":
//                System.out.println("=======");
...
//        System.out.println(this.name);
        for (NodeArret nbs: nodeBusStopArrayList){
//            System.out.println(nbs);
    ...
    public String nameLineWithBusStops(String busStopName1, ArrayList<String> listHourOfPassage1, String busStopName2, ArrayList<String> listHourOfPassage2, String typeDay) {
        switch (typeDay) {
            case "saturday or summer":
...
//        System.out.println(this.getName());
    ...
    public boolean isAfter(Ligne line, String busStopName1, ArrayList<String> listHourOfPassage1, String busStopName2, ArrayList<String> listHourOfPassage2){
...
//                line.isAfter(busStopName2, busStopName1);
    ...
    public ArrayList<NodeArret> getNodeBusStop(String nameBusStop, String typeDay){
        ArrayList<NodeArret> outputList = new ArrayList<>();
        switch (typeDay) {
            case "saturday or summer":
