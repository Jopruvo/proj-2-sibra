...
public class NodeArret {

    private String nameBus;
    private String nameLine;
    private Arret busStop;

    private ArrayList<NodeArret> nextNodeBusStops = new ArrayList<>();

    public NodeArret(String nameBus, String nameLine, Arret busStop){
    ...
    public void addNextNodeBusStops(NodeArret nodeBusStop){
