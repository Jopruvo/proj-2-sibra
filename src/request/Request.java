...
//        System.out.println("minutes: " + sMinutes);
    ...
    public int getNextBusAtThisHour(NodeArret departureBusStopNode, String hour) {
    ...
    public ArrayList<NodeArret> busStopToNodeBusStops(String busStopName){
    ...
    public int getTimeBetweenTwoBusStop(String busStop1, String busStop2){
        ...
        ArrayList<NodeArret> nodeBusStops1 = busStopToNodeBusStops(busStop1);
        ArrayList<NodeArret> nodeBusStops2 = busStopToNodeBusStops(busStop2);
...
//        System.out.println("nodeBusStops2: " + nodeBusStops2);
        ...
        for (NodeArret nbs1: nodeBusStops1){
            for (NodeArret nbs2: nodeBusStops2){
...
//                    System.out.println("line nbs2: " + nbs2.getNameLine());
    ...
    public boolean isBusStopInList(String busStopName, String lineName, String busName, ArrayList<NodeArret> nodeBusStops){
    ...
    public boolean isBusStopInPathList(String busStopName, ArrayList<Chemin> nodeBusStops){
        for (Chemin p: nodeBusStops){
